            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Administración - Aplicación Clasificados  - </h3>
                    </div>
                    <div class="panel-body">
                        {{ Form::open(array('url' => '/login', 'method' => 'post')) }}
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Correo electrónico" name="email" id="email" type="email" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Clave" name="password" id="password"  type="password" value="">
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input name="remember" type="checkbox" value="Remember Me"> Recordarme &nbsp;<i class="fa icon-key icon-3"></i>
                                    </label>
                                </div>
    ...
    <div class="container">
        <div class="row">
         <div class="alert alert-danger col-md-4 col-md-offset-4">
            <h4><i class="icon-warning-sign icon-4"></i> {{$errors->first()}}</h4>
         </div>
     	</div>
     </div>
  @endif
